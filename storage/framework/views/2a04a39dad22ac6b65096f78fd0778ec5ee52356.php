...
<head>
  ...
  <?php echo Html::style(url('plugins/iCheck/square/blue.css')); ?>
...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>Africab Rental</b></a>
  </div>
  <!-- /.login-logo -->
     ...
     <?php echo csrf_field(); ?>
      ...
      <div class="row">
        ...
        <div class="col-xs-4">
          ...
          <button type="submit" class="btn btn-primary btn-block btn-flat"> <?php echo e(__('Log in')); ?></button>
        </div>
        <!-- /.col -->
      </div>
    </form>
...
<?php echo Html::script(url('plugins/iCheck/icheck.min.js')); ?>
...
<?php /**PATH C:\xampp\htdocs\africab_rental\resources\views/auth/login.blade.php ENDPATH**/ ?>