  ...
  <div class="col-md-3">
    ...
    <div class="box box-primary">
      <div class="box-body box-profile">
        ...
        <h3 class="profile-username text-center"><?php echo e($property->property_name); ?></h3>

        <p class="text-muted text-center"> <?php echo e($property->property_code); ?>  </p>

        <ul class="list-group list-group-unbordered">
          <li class="list-group-item">
            <b>Total Units</b> <a class="pull-right"><?php echo e($property->unit_total); ?></a>
          </li>
          <li class="list-group-item">
            <b>Vacants</b> <a class="pull-right"><?php echo e($vacants); ?></a>
          </li>
          <li class="list-group-item">
            <b>Occupied</b> <a class="pull-right"><?php echo e($occupied); ?></a>
          </li>
        </ul>
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <p class="text-muted"> <?php echo e($property->company->company_name); ?> </p>
        <hr>
        ...
        <hr>
        <p class="text-muted"> <?php echo e($property->region->name); ?> </p>
      </div>
      <!-- /.box-body -->
    </div>
    <!-- /.box -->
  ...
  <div class="col-md-9">
    <div class="nav-tabs-custom">
      <ul class="nav nav-tabs">
        ...
        <li><a href="#units" data-toggle="tab"><span class="label bg-blue"> <?php echo e($units->count()); ?></span>Units List</a></li>
      </ul>
      <div class="tab-content">
        <div class="active tab-pane" id="activity">
          ...
          <form class="form-horizontal" action="<?php echo e(route('units.store')); ?>" method="post">
            <input type="hidden" name="property_id" value="<?php echo e($property->id); ?>" require/>
            <?php echo csrf_field(); ?>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <select class="form-control select2"  data-placeholder="select unit mode" name="unit_mode_id" id="unit_mode_id">
                  <option></option>
                  <?php $__currentLoopData = $unitModes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unitMode): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($unitMode->id); ?>"><?php echo e($unitMode->unit_mode_name); ?></option>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
              </div>
            </div>
            ...
            <tbody>
              <?php $__currentLoopData = $units; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                  ...
                  <td><?php echo e($unit->unit_floor); ?></td>
                  <td><?php echo e($unit->total_rooms); ?></td>
                  <td><?php echo e($unit->unitType->unit_type_name); ?></td>
                  <td><?php echo e($unit->unitMode->unit_mode_name); ?></td>
                </tr>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </tbody>
          </table>
...
<script>
  $(document).ready(function(){
    ...
    $('#unit_mode_id').change(function(){
      unitType = $(this).val(); 
      url = "<?php echo e(route('unit_mode_types',':unitType')); ?>";
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\africab_rental\resources\views/property/property_unit.blade.php ENDPATH**/ ?>